...
exports.EnvironmentLoader = exports.ApiClient = exports.CartSecurityTestSuite = void 0;
...
EnvironmentLoader.config = null;
class ApiClient {
    constructor(config) {
        this.config = config;
    }
    async request(endpoint, options = {}) {
        const { method = 'GET', headers = {}, body, useServiceKey = false } = options;
    ...
    async callEdgeFunction(functionName, payload, token) {
        const headers = {};
        if (token) {
    ...
    async queryTable(table, query = '', useServiceKey = false) {
...
class CartSecurityTestSuite {
    constructor(api) {
        this.results = [];
        this.TEST_VARIANT_ID = '00fc5e6f-aeb8-44b3-b3ef-0a561feb359f'; // Business Blazer
    ...
    async runSuite1_Authentication() {
    ...
    async runSuite3_OrderPipeline() {
        ...
        suite.tests.push(await this.runTest('3D', 'Data Integrity Verification', async () => {
            ...
            const orders = await this.api.queryTable('orders', `payment_intent_id=eq.${paymentIntentId}&select=*`, true);
    ...
    async runSuite4_SecurityValidation() {
...
exports.CartSecurityTestSuite = CartSecurityTestSuite;
// Main execution
async function main() {
    try {
